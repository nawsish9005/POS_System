...
namespace POS_API.Migrations
{
    ...
    [Migration("20250505052028_upd context")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS_API.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS_API.Models.LoyaltyPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS_API.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("POS_API.Models.Tax", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("POS_API.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("POS_API.Models.LoyaltyPoint", b =>
                {
                    b.HasOne("POS_API.Models.Customer", null)
                        .WithMany()
